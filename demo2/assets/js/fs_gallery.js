...
jQuery.fn.fs_gallery = function (fs_options) {
    ...
    var resetBannerSize = function(){
        var bannerBoxWidth = jQuery(".fs_gallery_container").width();
        var scale = 1920/1280;
        var bannerBoxHeight = bannerBoxWidth/scale;
        jQuery(".fs_gallery_container .fs_slide,.slider").height(bannerBoxHeight);
