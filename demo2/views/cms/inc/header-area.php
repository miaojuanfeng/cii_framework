					...
					<div class="row">
						...
						<div class="menu-column-area col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-6">
							...
							<ul>
								...
								<li><a href="<?=base_url()?>" target="_blank">Website</a></li>
							</ul>
						</div>
						...
						<div class="menu-column-area col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-6">
							...
							<ul>
								...
								<li><a href="<?=base_url('cms/menu')?>">Menu</a></li>
								<li><a href="<?=base_url('cms/news')?>">News</a></li> -->
								<li><a href="<?=base_url('cms/page')?>">Page</a></li>
								<li><a href="<?=base_url('cms/video')?>">Video</a></li>
							</ul>
						</div>
						...
						<div class="menu-column-area col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ms-6">
							...
							<ul>
								...
								<li><a href="<?=base_url('cms/book')?>">Book</a></li> -->
		...
		<div class="btn-group show-myself">
			<a href="#" class="btn btn-primary btn-ms dropdown-toggle" data-toggle="dropdown">
				<i class="glyphicon glyphicon-user"> <?=ucfirst(get_user($this->session->userdata('user_id'))->user_name)?></i>
			</a>
			<ul class="dropdown-menu dropdown-menu-right" role="menu">
				<li><a href="<?=base_url('cms/login')?>">Logout: <?=ucfirst(get_user($this->session->userdata('user_id'))->user_name)?></a></li>
			</ul>
		</div>
