...
<link rel="shortcut icon" href="<?=base_url('assets/img/favico.ico')?>" type="image/x-icon">
<link rel="apple-touch-icon" href="<?=base_url('assets/img/apple_icons_57x57.png')?>">
<link rel="apple-touch-icon" sizes="72x72" href="<?=base_url('assets/img/apple_icons_72x72.png')?>">
<link rel="apple-touch-icon" sizes="114x114" href="<?=base_url('assets/img/apple_icons_114x114.png')?>">
...
<link rel="stylesheet" href="<?=base_url('assets/css/theme.css')?>" type="text/css" media="all" />
